...
function makeHtmlBoard() {
  ...
  // Create the first row on top of the board that detects user click and performs function
  ...
  // TODO: add comment for this code -- DONE
  // Create game board with size based on HEIGHT and WIDTH and assign a unique ID in each
  for (let y = 0; y < HEIGHT; y++) {
...
function checkForWin() {
  ...
  for (let y = 0; y < HEIGHT; y++) {
    for (let x = 0; x < WIDTH; x++) {
      ...
      //checks for win condition horizontally, vertically,  diagonally to upper right, diagonally to upper left
